...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['contact'])) {
    ...
    if (empty($_POST['firstname']) || empty($_POST['lastname']) || empty($_POST['email']) || empty($_POST['message'])) {
        ...
        if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
            $error = "Электрондық поштаның дұрыс пішімі емес";
        } else {
            try {
                // Дерекқорға қосылу
                ...
                if ($stmt->execute()) {
                    ...
                    $error = "Хабарламаны жіберу сәтсіз аяқталды. Кейінірек қайталап көріңіз.";
                }
            } catch (PDOException $e) {
                error_log("Database Error: " . $e->getMessage(), 3, "logs/errors.log"); // Логқа жазу
                $error = "Дерекқор қатесі орын алды. Кейінірек қайталап көріңіз.";
            }
        }
    }
}
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-4">
            <div class="card product-card border-0 rounded-4 shadow-sm">
                <div class="position-relative">
                    <div class="overflow-hidden">
                        <img src="https://web.courstore.com/wp-content/uploads/2023/11/1-1.jpg"
                ...
                <div class="card-body p-4">
                    ...
                    <p class="card-text text-muted mb-4">ҚМЖ жазуда заманауи интерактивті құралдар мен белсенді
                        әдістерді қолдану (БАЗАЛЫҚ БІЛІМ)</p>
                    <div class="d-flex justify-content-between align-items-center">
                        <span class="price">40 000 ₸</span>
                        <a href="https://app.courstore.com/kk/courses/mzh-zhazuda-zamanaui-interaktivti-raldar-men-bels"
                            class="btn btn-dark text-white px-4 py-2 rounded-pill">
                            Сатып алу
                        </a>
                    </div>
                </div>
            ...
            <div class="card product-card border-0 rounded-4 shadow-sm">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="https://app.courstore.com/kk/courses/copy-mzh-zhazuda-zamanaui-interaktivti-raldar-men-bels"
                            class="btn btn-dark text-white px-4 py-2 rounded-pill">
                            Сатып алу
                        </a>
                    </div>
            ...
            <div class="card product-card border-0 rounded-4 shadow-sm">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="https://app.courstore.com/kk/courses/copy-copy-mzh-zhazuda-zamanaui-interaktivti-raldar-men-bels"
                            class="btn btn-dark text-white px-4 py-2 rounded-pill">
                            Сатып алу
                        </a>
                    </div>
                ...
                <div class="contact-form p-5 card feature-card">
                    <form method="POST">
                        ...
                        <div class="form-floating mb-3">
                            <input name="firstname" type="text" class="form-control rounded-3" id="floatingInput"
                                placeholder="Атыңыз">
                            <label for="floatingInput">Аты</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input name="lastname" type="text" class="form-control rounded-3" id="floatingInput"
                                placeholder="Тегіңіз">
                        ...
                        <div class="col-12 mb-3">
                            <textarea name="message" class="form-control custom-input" rows="5"
                                placeholder="Хабарламаңыз"></textarea>
                        </div>
                        <div class="col-12">
